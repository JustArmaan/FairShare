...
export const Overview = ({ transactions }: { transactions: Transaction[] }) => {
  return (
    <>
      <div id="app">
        <div class="bg-primary-black-page">
          {" "}
          {/*Margin left and right might become a div later for cleaner code*/}
          <h1 class="ml-4 text-2xl text-font-off-white pt-2">
            {" "}
            Welcome, Holden
          </h1>{" "}
          ...
          <div class="bg-primary-black mx-5 relative">
            ...
            <p class="ml-4 mt-2 text-base text-font-off-white">
              Monthly Breakdown
            </p>
          </div>
          <div class="m-4">
            <div class="flex flex-row justify-between text-center items-center mb-0 underline">
              <p class="text-xl text-font-off-white mt-3">
                Transaction History
              </p>
              <a
                hx-get="/transactions"
