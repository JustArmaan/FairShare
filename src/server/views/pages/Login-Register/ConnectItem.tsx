  ...
  return (
    <div class="h-screen animate-fade-in">
      ...
      <div class="absolute h-2/3 z-10">
        ...
        <img src="./images/color.webp" class="h-full "></img>
      </div>
      ...
      <div class="z-20 h-screen flex flex-col items-center relative">
        ...
        <div class="flex flex-col text-font-off-white font-normal text-lg mt-2 text-center w-[13.125rem] h-[3.125rem]">
          <button
            id="connect-to-plaid"
            class="rotate-[0.00001deg] hover:-translate-y-0.5 transition-all bg-accent-blue rounded-2xl w-full py-[0.5rem] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] mt-8"
          >
            Click to connect
          </button>
        </div>
