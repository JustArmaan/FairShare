    ...
    <>
      <div class="w-screen h-screen">
        ...
        <div class="z-20 w-screen h-screen flex flex-col items-center justify-center relative">
          ...
          <div class="flex flex-col text-font-off-white font-normal text-lg mt-10 text-center w-4/5">
            <a href="/auth/login">
            ...
            <a href="/auth/register">
              <button class="hover:-translate-y-0.5 transition-all bg-accent-blue rounded-3xl w-full py-[0.5rem] mt-4">
                Register
              </button>
            </a>
          </div>
