...
export const Transaction = ({ transaction }: TransactionsData) => {
  return (
    <div class="mt-4 bg-primary-black p-2 rounded-xl shadow-md mb-1 flex items-center justify-between">
      <div class="flex items-center">
        <div
          class={`p-3 pl-4 pr-4 mr-4 ${iconColors[Math.floor(Math.random() * (iconColors.length - 1))]} rounded-xl`}
        >
          <img
            src={
              randomIconPaths[
